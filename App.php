...
class App extends BaseConfig {
     ...
     * @var string
     */
    public $baseURL = 'https://localhost/notary/';//'phpstack-249906-4047771.cloudwaysapps.com/';//https://localhost/rise/;ev.villasomalia.gov.so
     ...
     * @var string
     */
    public $uriProtocol = 'PATH_INFO';//'PATH_INFO';//REQUEST_URI
     ...
     * @var string
     */
    public $appTimezone = 'Africa/Mogadishu';
    ...
    /* User configs */
    public $encryption_key = "b44aebbf75169b5";
    ...
    public $properties_file_path = 'files/properties_file_path/';
    public $agreements_file_path = 'files/agreements_file_path/';
    public $images_file_path = 'assets/images/';
