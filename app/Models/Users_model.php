...
class Users_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sql = "SELECT SQL_CALC_FOUND_ROWS $users_table.*, $roles_table.title AS role_title,$team_member_job_info_table.job_title_so,$team_member_job_info_table.job_title_en,
            $team_member_job_info_table.date_of_hire, $team_member_job_info_table.salary, $team_member_job_info_table.salary_term,$team_member_job_info_table.department_id,$team_member_job_info_table.signature $select_custom_fieds
        FROM $users_table
    ...
    function get_access_info($user_id = 0) {
        ...
        $sql = "SELECT $users_table.id, $users_table.user_type, $users_table.is_admin as is_admin, $users_table.role_id, $users_table.email,
