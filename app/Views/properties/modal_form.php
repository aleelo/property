<?php echo form_open(get_uri("properties/save"), array("id" => "client-form", "class" => "general-form", "role" => "form")); ?>
<div id="properties-dropzone" class="post-dropzone">
    ...
    <div class="modal-footer">
        <div id="link-of-add-contact-modal" class="hide">
            <?php echo modal_anchor(get_uri("properties/add_new_contact_modal_form"), "", array()); ?>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploadUrl = "<?php echo get_uri("properties/upload_file"); ?>";
        var validationUri = "<?php echo get_uri("properties/validate_events_file"); ?>";
