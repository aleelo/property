...
<script type="text/javascript">
    ...
    var quick_filters_dropdown = <?php echo view("properties/quick_filters_dropdown"); ?>;
    ...
    $(selector).appTable({
    source: '<?php echo_uri("properties/list_data") ?>',
            serverSide: true,
...
<?php echo $custom_field_filters; ?>
            ...
            {title: "<?php echo app_lang("area") ?>", order_by: "area"},
            {title: "<?php echo app_lang("property_value") ?>", order_by: "propertyValue"},
            {title: "<?php echo app_lang("created_at") ?>", order_by: "registrationDate"},
