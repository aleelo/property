...
<script type="text/javascript">
    ...
    function getFooterTotal(total=0.0,el){
        ...
        curTotal = localStorage.getItem('curTotal2');
        total = curTotal - t;
    ...
    $(document).ready(function () {
        ...
        $('#order_id').on('change',function(e){
            ...
            $.ajax({
                    url: 'purchase_receive/order_details_json',
                    data: {
                    ...
                    success: function (res) {
                        ...
                        // console.log(res);
                        if(res){
                            $('#product_type').val(res.product_type).trigger('change');
            ...
            function getPurchaseItemsDetail(){
                
                $.ajax({
                    url: 'purchase_receive/order_items_json/'+$('#order_id').val(),
                    cache: false,
                    type: 'GET',
                    success: function (data) {
                        ...
                        if(data.length > 0 && data[0].id != null){
                            ...
                            localStorage.setItem('curTotal2', total);
