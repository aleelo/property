<div id="page-content" class="page-wrapper clearfix grid-button leads-view">
    <ul class="nav nav-tabs bg-white title" role="tablist">
        <li class="title-tab leads-title-section"><h4 class="pl15 pt10 pr15"><?php echo app_lang("purchase_receive"); ?></h4></li>
        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                ...
                <?php echo modal_anchor(get_uri("purchase_receive/receive_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_purchase_receive'), array("class" => "btn btn-default", "title" => app_lang('add_purchase_receive'))); ?>
            </div>
        </div>
    </ul>
...
<script type="text/javascript">
    ...
    source: '<?php echo_uri("purchase_receive/receive_list_data") ?>',
            serverSide: true,
            ...
            {title: "<?php echo app_lang("received_by") ?>", order_by: "received_by"},
