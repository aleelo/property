...
<script type="text/javascript">
    ...
    var quick_filters_dropdown = <?php echo view("agreements/quick_filters_dropdown"); ?>;
...
<?php echo $custom_field_filters; ?>
            ...
            {title: "<?php echo "title_deed_no" ?>", "class": "all", order_by: "titleDeedNo"},
            {title: "<?php echo "Notary Ref" ?>", order_by: "notary_ref"},
            {title: "<?php echo "Buyer" ?>", order_by: "buyer"},
            {title: "<?php echo "Seller" ?>", order_by: "seller"},
            {title: "<?php echo "Witness" ?>", order_by: "witness"},
            {title: "<?php echo "Agreement Type" ?>", order_by: "agreement_type"},
