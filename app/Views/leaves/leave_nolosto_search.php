        ...
        <style>
            #nolosto-table tbody th, #nolosto-table tbody td {
            ...
            @media print {
                ...
                #nolosto-table.dataTable.display tbody th, #nolosto-table.dataTable.display tbody td {
                    border-top: 1px solid #f2f2f2;
                    padding-left: 40px !important;
                    background-color: #73c7fc !important;
                    color: white;
                ...
                #nolosto-table tbody td,#nolosto-table tbody th {
                border-top: 1px solid #f2f2f2;
                    padding-left: 40px !important;
                    background-color: #73c7fc !important;
                    color: white;
    ...
    <div class=" col-md-4 search-container" style="margin-left:auto;margin-right: auto;" id="search-container">
        ...
        <div class="card col-xs-12 mt-3 shadow-lg " style="background-color: #73c7fc !important;color: white;" id="search-card1">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="table-responsive mb15">
                        <table class="table dataTable display b-t" id="nolosto-table">
                        <tr>
