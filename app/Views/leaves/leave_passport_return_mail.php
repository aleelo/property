        ...
        <div class="shadow d-flex justify-content-center col-xs-12 mt-3 mb-3 " id="search-card1">
            ...
            justify-content: center;height: 25px;">
                    ...
                    <div class="ticket-body" style=" padding: 20px 15px;">
                        <h2 class="text-center mb-3" style="margin-bottom: 15px;color: #ad6102;text-align:center;margin-top: 0;"><?php echo strtoupper($leave_info->leave_type) ?></h2>
                        <div class="ticket-name">
                            <p style=" font-size: 0.9rem;
                                font-weight: 300;margin:0;">Howlwadeen:</p>
                            <h2 style="font-size: 20px;margin:0;"><?php echo $leave_info->applicant_name;?></h2>
                        </div>
                        <div class="ruler"  style="margin: 1rem 0; height: 1px; background: #b36f00;"></div>
                        <div class="ticket-number-date" style=" margin: 0 10%;">
                            <div style="float: left;">
                                <p style="font-size: 0.9rem;margin:0;">PASSPORT NO.</p>
                        ...
                        <div class="ruler"  style="margin: 1rem 0; height: 1px; background: #b36f00;clear: both;"></div>
                        <div class="ticket-from-and-to justify-content-center" style="">
                        ...
                        <div class="bording" style=" margin-top: 10px;margin-left: auto;margin-right: auto;">
                            <div class="bording-content" style="padding: 20px 35px;border: 2px dashed #b36f00;text-align: center;">
                        ...
                        <?php
                            ...
                            echo "<img style='border-radius: 7px;border: 1px solid #b55300;' width='150' src=".get_uri('files/system/qrcode.png')." alt='Scan to see' />";?>
