            ...
            <div class="" >                   
                <div class="container">
                    ...
                    <div class="ticket-body">
                        <h2 class="text-center mb-3" style="margin-bottom: 15px;"><?php echo strtoupper($leave_info->leave_type) ?></h2>
                        ...
                        <div class="ticket-from-and-to justify-content-center">
                            <div class="clearfix" style="display: flex;width: 100%;align-items: center;text-align: center;justify-content: center;gap: 30px;">
                                ...
                                <div class="ps-2 pt5">
                                    ...
                                    <p><span class='badge bg-primary' style="border-radius: 20px;"><?php echo $leave_info->job_title; ?></span> </p>
                                </div>
                            </div>
                        </div>
