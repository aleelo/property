<?php echo form_open(get_uri("agency/save"), array("id" => "client-form", "class" => "general-form", "role" => "form")); ?>
<div id="properties-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            <input type="hidden" name="ticket_id" value="<?php echo $ticket_id; ?>" />
            <?php echo view("agency/property_form_fields"); ?>
    ...
    <div class="modal-footer">
        <div id="link-of-add-contact-modal" class="hide">
            <?php echo modal_anchor(get_uri("agency/add_new_contact_modal_form"), "", array()); ?>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploadUrl = "<?php echo get_uri("agency/upload_file"); ?>";
        var validationUri = "<?php echo get_uri("agency/validate_events_file"); ?>";

        var dropzone = attachDropzoneWithForm("#properties-dropzone", uploadUrl, validationUri);
