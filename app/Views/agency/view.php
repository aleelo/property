    ...
    <div class="container-fluid  full-width-button">
        <div class="row clients-view-button">
            <div class="col-md-12">
                <div class="page-title clearfix no-border no-border-top-radius no-bg">
                    <h1 class="pl0">
                        ...
                        <span id="star-mark">
                            <?php
                            if ($is_starred) {
                                echo view('agency/star/starred', array("client_id" => $properties_info->id));
                            } else {
                                echo view('agency/star/not_starred', array("client_id" => $properties_info->id));
                            }
                            ?>
                        </span>
                ...
                <div>
                    <?php// echo view("agency/info_widgets/index"); ?>
                </div>

                <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs" role="tablist">
                    
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("agency/company_info_tab/" . $properties_info->id); ?>" data-bs-target="#client-info"> <?php echo 'Properties Info'; ?></a></li>

                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("agency/files/" . $properties_info->id); ?>" data-bs-target="#client-files"><?php echo app_lang('files'); ?></a></li>
