<?php echo form_open(get_uri("agents/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="property_id" value="<?php echo $property_id; ?>" />
        <?php
        echo view("includes/multi_file_uploader", array(
            "upload_url" => get_uri("agents/upload_file"),
            "validation_url" => get_uri("agents/validate_file"),
        ));
        ?>
    </div>
</div>
