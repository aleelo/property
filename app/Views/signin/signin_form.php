    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="w-100 mb-3 d-flex p-3">
                <div class="w-45" style="height: 2px;background: #ddd;width: 38%;"></div>
                <div class="mx-3  fs-5 d-flex" style="margin-top: -15px;">
                    <svg width="30" height="30" class="" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <linearGradient id="e399c19f-b68f-429d-b176-18c2117ff73c" x1="-1032.172" x2="-1059.213" y1="145.312" y2="65.426" gradientTransform="matrix(1 0 0 -1 1075 158)" gradientUnits="userSpaceOnUse">
                                    <stop offset="0" stop-color="#114a8b"></stop>
                ...
                <div class="w-45 " style="height: 2px;background: #ddd;width: 40%;"></div>
            </div>
