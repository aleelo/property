<div class="card bg-white mb15">
    ...
    <div class="form-group">
        <!-- azure login button -->
        <!-- <?php //echo form_open("signin/aad_signin", array("id" => "azure-signin-form", "class" => "general-form", "role" => "form")); ?>
        ...
        <div class="form-group">
            ...
            ),['Normal Login'=>'Normal Login','Azure Login' => 'Azure Login'],['Azure Login' => isset($_GET['login_type']) ? $_GET['login_type'] : 'Azure Login']);
            ?>
        </div>
        <hr>
        <div class="form-group">
        ...
        <button type = "submit" name="azure-login-btn" id="azure-login-btn" class="btn btn-primary btn-lg w-100 mb-4">
            ...
            <button type = "submit" name="azure-login-btn" id="normal-login-btn" class="btn btn-warning btn-lg w-100 mb-4" style="display:none; color: rgb(180, 37, 0)">
