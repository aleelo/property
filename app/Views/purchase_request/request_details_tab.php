<div class="clearfix default-bg">
    <div class="row">
            ...
            <div class="card p15 w-100">
                <div id="page-content" class="clearfix grid-button">
                    <div style="max-width: 1000px; margin: auto;">
                        ...
                        <div class="clearfix">
                            <?php if ($can_add_purchase &&  strtolower($purchase_info->status) !== 'cancelled' &&  strtolower($purchase_info->status) !== 'delivered') { ?>
                            ...
                            <div class="float-end pr15" id="invoice-total-section">
                                <?php //echo view("purchase_request/purchase_total_section", array("purchase_id" => $purchase_info->id,'purchase_total_summary'=>$purchase_total_summary, "can_add_purchase" => $can_add_purchase)); ?>
                            </div>
                        </div>           
        ...
        <?php                     
            ...
            }else if (strtolower($purchase_info->status) === "delivered") {
                $status_class = "btn-success";//btn-success
            } else if (strtolower($purchase_info->status) === "submitted") {
                $status_class = "bg-success";//btn-success
            }  else if (strtolower($purchase_info->status) === "cancelled") {
                $status_class = "bg-danger";//btn-success
            
            } else if (strtolower($purchase_info->status) === "rejected") {
    ...
    $(document).ready(function () {
        ...
        $("#purchase-item-table").appTable({
            ...
            columns: [
                ...
                {title: '<?php echo app_lang("description") ?>', "class": "text-right w15p", sortable: false},
