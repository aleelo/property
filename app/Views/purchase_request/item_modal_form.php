<?php echo form_open(get_uri("purchase_request/save_item"), array("id" => "invoice-item-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />
        <input type="hidden" id="item_id" name="item_id" value="<?php echo $model_info->item_id; ?>" />
        <input type="hidden" name="purchase_request_id" value="<?php echo $purchase_request_id; ?>" />
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#invoice_item_name").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("purchase_request/get_purchase_item_suggestion"); ?>",
                type: 'POST',
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("purchase_request/get_purchase_item_info_suggestion"); ?>",
                    data: {item_id: e.val},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
