...
<!--                                     
                                    ...
                                    <li role="presentation"><?php //echo js_anchor("<i data-feather='printer' class='icon-16'></i> " . app_lang('print'), array('title' => app_lang('print'), 'id' => 'print-invoice-btn', "class" => "dropdown-item")); ?> </li> -->
                                        ...
                                        <li role="presentation"><?php echo anchor(get_uri("purchase_request/get_requisition_order_document/" . $purchase_info->uuid),"<i data-feather='external-link' class='icon-16'></i> " . app_lang('requisition_form'), array('title' => app_lang('requisition_form'), 'target' => '_blank',  "data-reload-on-success" => "1", "class" => "dropdown-item")); ?> </li>
