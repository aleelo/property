    ...
    <ul class="nav nav-tabs bg-white title" role="tablist">
        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                ...
                <?php echo modal_anchor(get_uri("purchase_order/order_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_purchase_order'), array("class" => "btn btn-default", "title" => app_lang('add_purchase_order'))); ?>
            </div>
        </div>
    </ul>
