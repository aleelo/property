...
class Email_templates extends Security_Controller {
    ...
    private function _templates() {
        ...
        $templates_array["employee"] = array(
            "leave_nulla_osta" => array("LEAVE_ID", "LEAVE_TITLE", "EMPLOYEE_NAME", "HTML_TEMPLATE", "LEAVE_REASON", "LEAVE_URL","LEAVE_DATE","TOTAL_DAYS", "LOGO_URL", "SIGNATURE","EMAIL_HEADER_URL","EMAIL_FOOTER_URL"),
            "leave_passport_return" => array("LEAVE_ID", "LEAVE_TITLE", "EMPLOYEE_NAME", "HTML_TEMPLATE", "LEAVE_REASON", "LEAVE_URL","LEAVE_DATE","TOTAL_DAYS", "LOGO_URL", "SIGNATURE","EMAIL_HEADER_URL","EMAIL_FOOTER_URL"),
            ...
            //send email as pdf for external purposes e.g. immigration.
            "leave_nulla_osta_pdf" => array("LEAVE_ID", "LEAVE_TITLE", "EMPLOYEE_NAME", "LEAVE_URL", "LOGO_URL", "SIGNATURE", "LEAVE_STATUS","EMAIL_HEADER_URL","EMAIL_FOOTER_URL"),
            "leave_passport_return_pdf" => array("LEAVE_ID", "LEAVE_TITLE", "EMPLOYEE_NAME", "LEAVE_URL", "LOGO_URL", "SIGNATURE", "LEAVE_STATUS","EMAIL_HEADER_URL","EMAIL_FOOTER_URL")
        );
