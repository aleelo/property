...
class Purchase_Receive extends Security_Controller
{
    ...
    function get_purchase_item_info_suggestion() {
        $item = $this->Purchase_Order_Items_model->get_item_info_suggestion(array("item_id" => $this->request->getPost("item_id")));
        if ($item) {
    ...
    function order_details_tab($purchase_order_id) {
                // die($purchase_order_id);
        $model_info = $this->Purchase_Order_model->get_details(['id' => $purchase_order_id])->getRow();
    ...
    function view($purchase_order_id = 0) {
        ...
        if ($purchase_order_id) {;
            $order_options = array('purchase_order_id' => $purchase_order_id);
